    ...
    <header className="bg-white border-b border-slate-200 h-16 sticky top-0 z-10 px-4 md:px-8 flex items-center justify-between shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          <span className="text-xs font-bold uppercase tracking-widest text-slate-400 block leading-none">Accounts Registry Hub</span>
      ...
      <div className="flex items-center gap-3 md:gap-4 font-semibold text-slate-700">
        ...
        <button 
          onClick={() => alert("Accounts Handbook and portal support is accessible on standard campus desks. For assistance, raise an internal admin memo.")}
        ...
        <div className="items-center gap-2 hidden md:flex">
          <img 
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDo7g4pTyntEQKFiKAGCM_A7IyKSUZJ41yWozLpqOt0loQSxyRg2AOFlFZQ-Su6_m4nyiLmhGuUTTea5GDxZ8PjqYiD67GaE0Uw6VO_IBy6NI5uPgLdnVZjd1k5zfJvUPL1lU-qoepnmI-qNJs_pZ36sRWCI-SQQYsc8PPL44amWp985B4L_I6vTnVcYzCmTLTCjAq9_axY2vGrNiY-h6MqlbFNDY40LFUKRDkT7dZyI5p3K7ebdOFYH7gGpUBxH-24pqUezLAjKapa" 
            alt="A. Shankaran"
